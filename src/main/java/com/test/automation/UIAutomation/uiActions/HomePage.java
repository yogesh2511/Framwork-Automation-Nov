...
public class HomePage extends TestBase {
	...
	public static WebElement priorityCheck() {
		...
		try {
			prioritydropdown = com.test.automation.UIAutomation.config.ElementLoad.getWebElement("PriorityDropdown", hompagePropertyFile);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public static WebElement selectPageSize() {
		...
		try {
			selectPageSizedropdown = com.test.automation.UIAutomation.config.ElementLoad.getWebElement("PageSize", hompagePropertyFile);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public static void selecByColorPriority() {
		try {
			// log.info("****************try*********");
			AllRequirementlinks = com.test.automation.UIAutomation.config.ElementLoad.getWebElements("RequirementTotalList", hompagePropertyFile);
